...
function cb_boletoDeleteAntigos()
{
	...
	mysql_query("DELETE FROM boleto WHERE dataVencimento < '$xDias'");
}
...
function cb_boletoHistoricoInsert($nome, $tipo, $usuarioId = 0)
{
	...
	mysql_query("INSERT INTO historicoUsuario (nomeUsuario, data, tipo, usuarioId) VALUES ('$nome', '$datahora', '$tipo', '$usuarioId')");
}
...
function cb_mail($para, $assunto, $msg, $de = 'sistema@clientecivilcorp.com.br')
{
	...
	require_once('/home/clientecivilcorp/public_html/ohs/boletos/inc/PHPMailer/PHPMailerAutoload.php');
